...
<?php foreach($files as $f): ?><tr><td><?=$f['id']?></td><td><?=htmlspecialchars($f['original_name'])?></td><td><?=$f['created_at']?></td><td><a href="/download.php?id=<?=$f['id']?>">Download</a></td></tr><?php endforeach; ?></table>
