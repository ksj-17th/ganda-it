...
<nav><b>Shield Secure Transfer</b> &nbsp; <a href="/">Home</a><a href="/guest.php">Guest Link</a><?php if($me): ?><a href="/files.php">My Files</a><?php if($me['role']==='admin'): ?><a href="/admin/">Admin</a><?php endif; ?><a href="/logout.php">Logout</a><?php else: ?><a href="/login.php">Login</a><?php endif; ?></nav>
<div class="wrap">
